...
class TestOllamaProvider:
    ...
    async def test_complete_success(self):
        ...
        with patch.object(provider, "_get_client") as mock_get_client:
            ...
            request = CompletionRequest(
                messages=[Message(role=MessageRole.USER, content="Is the sky blue?")],
                model="llama3.2",
            )
    ...
    async def test_complete_connection_error(self):
        ...
        with patch.object(provider, "_get_client") as mock_get_client:
            ...
            request = CompletionRequest(
                messages=[Message(role=MessageRole.USER, content="Test")], model="llama3.2"
            )
    ...
    async def test_health_check_success(self):
        ...
        mock_response = {"models": [{"name": "llama3.2"}, {"name": "mistral"}]}
