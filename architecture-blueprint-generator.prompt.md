...
${PROJECT_TYPE="Other (Go + Python + React Polyglot)"} ${ARCHITECTURE_PATTERN="Microservices"} ${DIAGRAM_TYPE="Flow"} ${DETAIL_LEVEL="Implementation-Ready"} ${INCLUDES_CODE_EXAMPLES=true} ${INCLUDES_IMPLEMENTATION_PATTERNS=true} ${INCLUDES_DECISION_RECORDS=true} ${FOCUS_ON_EXTENSIBILITY=true}
